...
class DataDownloader:
    ...
    def download_data(self):
        ...
        # Replacing spaces in company names with underscores for folder naming
        ...
        # Downloading data for each selected company from Yahoo Finance
    ...
    # Converting 'Volume' column to integer type
        try:
    ...
    # Filling missing values in numerical columns with column means
